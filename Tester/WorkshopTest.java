...
class WorkshopTest { // Testklass for verkstadsgenerics.
    ...
    void volvoWorkshopReturnsExactType() {
        ...
        Assertions.assertTrue(ws.recieveCar(v));                 // Ska ga att lagga in Volvo i Volvo-verkstad.
    ...
    void genericWorkshopCanHandleDifferentVehicleTypes() {
        ...
        Assertions.assertTrue(ws.recieveCar(new Volvo240()));      // Volvo accepteras.
        Assertions.assertTrue(ws.recieveCar(new Saab95()));        // Saab accepteras.
        Assertions.assertEquals(2, ws.size());                // Två bilar inne i verkstaden.
    }
